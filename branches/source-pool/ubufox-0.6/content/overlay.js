...
{
  openUILink("https://launchpad.net/distros/ubuntu/intrepid/+sources/firefox-3.0/+gethelp", event, false, true);
}

function ubufoxHelpTranslateLaunchpad(event)
{
  openUILink("https://launchpad.net/distros/ubuntu/intrepid/+sources/firefox-3.0/+translate", event, false, true);
}
